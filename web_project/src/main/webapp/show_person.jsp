...
<body>
	...
	<h2>
		Name
		<jsp:getProperty property="name" name="personObj" /></h2>
	<h2>
		Age<jsp:getProperty property="age" name="personObj" /></h2>
	<h2>
		Weight<jsp:getProperty property="weight" name="personObj" /></h2>
</body>
</html>